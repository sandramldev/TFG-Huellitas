...
<body>
	...
	<div class="admin-form-wrapper">
		...
		<form class="admin-form"
			action="<%=request.getContextPath()%>/admin/CrearMascotaServlet"
			method="post">

			<label> <span class="material-icons">person</span> Cliente
			</label> <select name="clienteId" required>
			...
			</select> <label><span class="material-icons">pets</span>Nombre
